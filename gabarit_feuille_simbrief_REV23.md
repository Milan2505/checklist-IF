...
Dossier de référence : REV 23, ordre du §0 de la REV 23. Cinq cartouches, 39 cellules, dans l'état que la checklist en ligne lit aujourd'hui.
...
**Les deux portes** — elles ne s'estiment pas. C'est une donnée observée sur le traceur de trafic, ou rien. Non observées, les deux cellules portent `NIL` : une valeur pleine, qui passe la lecture et qui dit vrai. Jamais une porte déduite du terminal, de la compagnie ou de l'habitude de la ligne.
