...
const PHASES = [
  ...
  { n:"OFP & cartouches", s:"Les 34 cellules, puis les seuils carburant", items:[
    ...
    {t:"② Pistes et dégagement", d:"Piste départ {{piste}} cap {{capdep}}° · Piste arrivée {{arrpiste}} · Dégagement {{degag}} cap {{degcap}}° à {{degdist}} NM.", r:"A.4"},
    ...
    {t:"Les 34 cellules renseignées, aucune vide", d:"Une case vide sans motif affiché est un défaut de format de la feuille, pas de la page. Le bandeau d'anomalie nomme celles qui n'ont pas été résolues.", r:"A.5", w:1},
